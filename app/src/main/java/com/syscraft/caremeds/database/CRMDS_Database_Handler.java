...
import com.syscraft.caremeds.New_Model.Tomorrow_Mar_Bean;
...
public class CRMDS_Database_Handler extends SQLiteOpenHelper {
    ...
    public static final String TOMORROW_MARS_TABLE = "tomorrow_mars_table";
...
//    public static final String TODAY_MARS_UID = "uid";
    ...
    public static final String TMR_ID = "tmrid";
    public static final String TOMORROW_MARS_ID = "tomorrow_mar_id";
    public static final String TOMORROW_MARS_ADMINISTRATED_AT = "administrated_at";
    public static final String TOMORROW_MARS_DOSE = "dose";
    public static final String TOMORROW_MARS_FALSE_REASON = "false_reason";
    public static final String TOMORROW_MARS_IS_WASTE = "is_waste";
    public static final String TOMORROW_MARS_OUTCOME = "outcome";
    public static final String TOMORROW_MARS_QUANTITY_WASTED = "quantity_wasted";
    public static final String TOMORROW_MARS_SLOT_TIME = "slot_time";
    public static final String TOMORROW_MARS_UPDATED_AT = "updated_at";
    public static final String TOMORROW_MARS_USERID = "user_id";
    public static final String TOMORROW_MARS_USERNAME = "username";
    public static final String TOMORROW_MARS_USERFULLNAME = "user_fullname";
    public static final String TOMORROW_MARS_USEREMAIL = "email";
    public static final String TOMORROW_MARS_HOMELY_REMEDY_ID = "homely_remedy_id";
    public static final String TOMORROW_MARS_HOMELY_REMEDY_NAME = "homely_remedy_name";
    public static final String TOMORROW_MARS_PRESCRIPTION_ID = "prescription_id";
    public static final String TOMORROW_MARS_PATIENT_ID = "patient_id";
    public static final String TOMORROW_MARS_SECONDRY_USERID = "secondary_user_id";
    public static final String TOMORROW_MARS_SECONDRY_USERNAME = "seconday_username";
    public static final String TOMORROW_MARS_SECONDRY_USERFULLNAME = "seconday_user_fullname";
    public static final String TOMORROW_MARS_SECONDRY_USEREMAIL = "seconday_user_email";
...
//                + ");";
        ...
        String CREATE_TOMORROW_MARS_TABLE = "CREATE TABLE " + TOMORROW_MARS_TABLE + "("
                + TMR_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TOMORROW_MARS_ID + " TEXT, "
                + TOMORROW_MARS_ADMINISTRATED_AT + " TEXT, "
                + TOMORROW_MARS_DOSE + " TEXT, "
                + TOMORROW_MARS_FALSE_REASON + " TEXT, "
                + TOMORROW_MARS_IS_WASTE + " TEXT, "
                + TOMORROW_MARS_OUTCOME + " TEXT, "
                + TOMORROW_MARS_QUANTITY_WASTED + " TEXT, "
                + TOMORROW_MARS_SLOT_TIME + " TEXT, "
                + TOMORROW_MARS_UPDATED_AT + " TEXT, "
                + TOMORROW_MARS_USERID + " TEXT, "
                + TOMORROW_MARS_USERNAME + " TEXT, "
                + TOMORROW_MARS_USERFULLNAME + " TEXT, "
                + TOMORROW_MARS_USEREMAIL + " TEXT, "
                + TOMORROW_MARS_HOMELY_REMEDY_ID + " TEXT, "
                + TOMORROW_MARS_HOMELY_REMEDY_NAME + " TEXT, "
                + TOMORROW_MARS_PRESCRIPTION_ID + " TEXT, "
                + TOMORROW_MARS_PATIENT_ID + " TEXT, "
                + TOMORROW_MARS_SECONDRY_USERID + " TEXT, "
                + TOMORROW_MARS_SECONDRY_USERNAME + " TEXT, "
                + TOMORROW_MARS_SECONDRY_USERFULLNAME + " TEXT, "
                + TOMORROW_MARS_SECONDRY_USEREMAIL + " TEXT "
                + ");";
...
//        db.execSQL(CREATE_ABOUT_PATIENTS_INR_DETAIL_TABLE);
        ...
        db.execSQL(CREATE_TOMORROW_MARS_TABLE);
...
//        db.execSQL("DROP TABLE IF EXISTS " + ABOUT_PATIENTS_INR_DETAIL_TABLE);
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TOMORROW_MARS_TABLE);
        // Create tables again
        onCreate(db);
    }
...
//                        cursor.getString(23), cursor.getString(24), cursor.getString(25));
    ...
    public int update_Inr_Reading(String new_val, String p_id) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(PATIENT_INR_READING, new_val);
        // updating row
        return db.update(PATIENTS_TABLE, values, P_ID + " = ?", new String[]{p_id});
    }
...
//    // Updating single contact
    public int update_warfarin_dose(String new_val, String p_id) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(PATIENT_WARFARINE_DOSE, new_val);
        // updating row
        return db.update(PATIENTS_TABLE, values, P_ID + " = ?", new String[]{p_id});
    }
...
//
    ...
    public int update_inr_date(String new_val, String p_id) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(PATIENT_INR_DATE, new_val);
        // updating row
        return db.update(PATIENTS_TABLE, values, P_ID + " = ?", new String[]{p_id});
    }


    public String get_last_bs_site_prevouissite(String patient_id) {
        String content = "";
        String last_bs_site = "";
        String selectQuery = "SELECT * FROM " + PATIENTS_TABLE + " WHERE " + P_ID + " = " + "'" + patient_id + "'";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        Log.e("last_bs_site", "count --------->" + cursor.getCount());
        if (cursor.moveToLast()) {
//            do {
            last_bs_site = cursor.getString(21);
            Log.e("last_bs_site", "last_bs_site --------->" + last_bs_site);

            try {
                JSONObject jobj = new JSONObject(last_bs_site);
...
//            } while (cursor.moveToPrevious());
    ...
    //    // Updating single contact
    public int update_last_bs_site(String new_val, String p_id) {
        ...
        try {
            ...
            notedata.put("content", new_val);
            notedata.put("note_type", "BS_Site");
            notedata.put("updated_at", dtm);
            notedata.put("created_at", dtm);
        } catch (Exception e) {
            e.printStackTrace();
        }

        ContentValues values = new ContentValues();
        values.put(PATIENT_LAST_BS_SITE, notedata.toString());
        // updating row
        return db.update(PATIENTS_TABLE, values, P_ID + " = ? ", new String[]{p_id});
    ...
    public int update_last_bs_site_for_single_patient(String last_bs_site, String p_id) {

        Log.e("method", "update_Inr_Reading method------>" + p_id);
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(PATIENT_LAST_BS_SITE, last_bs_site);
        // updating row
        return db.update(PATIENTS_TABLE, values, P_ID + " = ? ", new String[]{p_id});
...
//                }
    ...
    // Getting All Contacts
    public ArrayList<PRESCRIPTION_Model_Phase2> get_admin_datalist_tab_prescriptions_FromDB(String patientId, String cycle_type) {
        ArrayList<PRESCRIPTION_Model_Phase2> prescription_common_modelArrayList = new ArrayList<PRESCRIPTION_Model_Phase2>();
...
//               + " AND " + KEY_ADMINISTERED_QUANTITY + " != " + "'" + val + "'";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                boolean b2 = Date_utility.is_date_between_two_dates(cursor.getString(6), cursor.getString(7));
...
//                if (!cursor.getString(6).equals("Irregular")) {
                    ...
                    ArrayList<Yesterday_Mar_Bean> yesterday_Mar_objects_list = get_admin_yesterday_mar_fromdb(cursor.getString(0), patientId);
                    contact.setYesterday_Mar_objects_list(yesterday_Mar_objects_list);
        ...
        if (cursor.moveToFirst()) {
            do {
                PRESCRIPTION_Model_Phase2 contact = new PRESCRIPTION_Model_Phase2(Integer.parseInt(cursor.getString(0)), cursor.getString(1),
                        ...
                        cursor.getString(26), cursor.getString(27), cursor.getString(28), cursor.getString(29), cursor.getString(30),
                        Integer.parseInt(cursor.getString(31)), cursor.getString(32), cursor.getString(33), cursor.getString(34), cursor.getString(35));
                // if available_quantity is greater than zero then it will show in return tab..
...
//        db.close();
    ...
    public void delete_general_notes_blankid() {
        SQLiteDatabase db = this.getWritableDatabase();
        int delete = db.delete(NOTES_TABLE, NOTES_PATIENT_ID + " = ?  AND " + NOTE_TYPE + " = ? ", new String[]{
                "", "General"});

        Log.e("delete_general_notes_blankid", "delete_general_notes_blankid delete--------->" + delete);
//        db.close();
    }
...
//            values.put(IS_ACTIVE, notesarraylist.get(i).getIs_active());
    ...
    public boolean update_NotesData_for_single_patient(ArrayList<NotesModel_Phase2> notesarraylist,
                                                       String operation_type, String nottype, String pid) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (operation_type.equals("online") && nottype.equals("General")) {
            ...
            for (int i = 0; i < notesarraylist.size(); i++) {
                delete_general_notes(pid);
                delete_general_notes_blankid();
            }
        }
...
//    }
    ...
    public void delete_measure_for_patient(String patient_id) {
        ...
        Log.e("delete_measure_for_patient", "delete_measure_for_patient delete--------->" + delete);
//        db.close();
    }
...
//            }
    ...
    public void update_homely_today_marsData(ArrayList<Homely_Today_Mars_Mar_Bean_Phase2> homely_today_mars_mar_bean_list, String status, String pid) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();

        Log.e("update_homely_today_marsData", "update_homely_today_marsData --------->" + homely_today_mars_mar_bean_list.size());

        if (status.equals("online")) {

            for (int i = 0; i < homely_today_mars_mar_bean_list.size(); i++) {
                delete_todaymar_record(homely_today_mars_mar_bean_list.get(i).getId());
                delete_todaymar_record_for_blankid(pid);
            }
        }
...
//        db.close();
    ...
    // Deleting single contact
    public void delete_yesterdaymar_record_for_blankid(String pid) {
        SQLiteDatabase db = this.getWritableDatabase();
        long deletecount = db.delete(YESTERDAY_MARS_TABLE, YESTERDAY_MARS_ID + " = ?  AND " + YESTERDAY_MARS_PATIENT_ID + " = ? ", new String[]{"", pid});
        Log.e("YESTERDAY deletecount", "YESTERDAY deletecount--->" + deletecount);
//        db.close();
    }
...
//        db.close();
    ...
    // Deleting single contact
    public void delete_todaymar_record_for_blankid(String pid) {
        SQLiteDatabase db = this.getWritableDatabase();
        long deletecount = db.delete(TODAY_MARS_TABLE, TODAY_MARS_ID + " = ?  AND " + TODAY_MARS_PATIENT_ID + " = ? ", new String[]{"", pid});
        Log.e("deletecount", "deletecount--->" + deletecount);
//        db.close();
    }

    // Deleting single contact
    public void delete_homely_todaymar_record() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TODAY_MARS_TABLE, TODAY_MARS_ID + " = ?", new String[]{""});
//        db.close();
    }
    ...
    // Deleting single contact
    public void delete_tomorrow_mar_record(String id) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TOMORROW_MARS_TABLE, TOMORROW_MARS_ID + " = ?", new String[]{
                String.valueOf(id)});
//        db.close();
    }
    ...
    // Deleting single contact
    public void delete_tomorrow_mar_record_for_blankid(String pid) {
        SQLiteDatabase db = this.getWritableDatabase();
        long deletecount = db.delete(TOMORROW_MARS_TABLE, TOMORROW_MARS_ID + " = ?  AND " + TOMORROW_MARS_PATIENT_ID + " = ? ", new String[]{"", pid});
        Log.e("deletecount", "deletecount--->" + deletecount);
//        db.close();
    }
...
//
    ...
    public void update_today_marsData_admin_for_single_patient(ArrayList<Today_Mars_Mar_Bean_Phase2> today_mars_mar_bean_list, String status, String Patientid) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();

        if (status.equals("online")) {
//            for (int i = 0; i < today_mars_mar_bean_list.size(); i++) {
            delete_todaymar_record_for_blankid(Patientid);
//            }
        }
        ...
        for (int i = 0; i < today_mars_mar_bean_list.size(); i++) {
            ...
            Log.e("TODAY_MARS_TABLE", "TODAY_MARS_ID --------->" + today_mars_mar_bean_list.get(i).getId());
...
//
    ...
    public void update_yesterday_marsData_admin_for_single_patient(ArrayList<Yesterday_Mar_Bean> yesterday_mar_bean_list, String status, String pid) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();
...
//                for (int i = 0; i < yesterday_mar_bean_list.size(); i++) {
                ...
                delete_yesterdaymar_record_for_blankid(pid);
//                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void insert_tomorrow_marsData_admin(ArrayList<Tomorrow_Mar_Bean> tomorrow_mar_bean_list, String status) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (status.equals("online")) {
            ...
            try {
                for (int i = 0; i < tomorrow_mar_bean_list.size(); i++) {
                    delete_tomorrow_mar_record(tomorrow_mar_bean_list.get(i).getId());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        for (int i = 0; i < tomorrow_mar_bean_list.size(); i++) {
            ...
            ContentValues values = new ContentValues();
            values.put(TOMORROW_MARS_ID, tomorrow_mar_bean_list.get(i).getId());
            values.put(TOMORROW_MARS_ADMINISTRATED_AT, tomorrow_mar_bean_list.get(i).getAdministered_at());
            values.put(TOMORROW_MARS_DOSE, tomorrow_mar_bean_list.get(i).getDose());
            values.put(TOMORROW_MARS_FALSE_REASON, tomorrow_mar_bean_list.get(i).getFalse_reason());
            values.put(TOMORROW_MARS_IS_WASTE, tomorrow_mar_bean_list.get(i).getIs_waste());
            values.put(TOMORROW_MARS_OUTCOME, tomorrow_mar_bean_list.get(i).getOutcome());
            values.put(TOMORROW_MARS_QUANTITY_WASTED, tomorrow_mar_bean_list.get(i).getQuantity_wasted());
            values.put(TOMORROW_MARS_SLOT_TIME, tomorrow_mar_bean_list.get(i).getSlot_time());
            values.put(TOMORROW_MARS_UPDATED_AT, tomorrow_mar_bean_list.get(i).getUpdated_at());
            values.put(TOMORROW_MARS_USERID, tomorrow_mar_bean_list.get(i).getUserid());
            values.put(TOMORROW_MARS_USERNAME, tomorrow_mar_bean_list.get(i).getUsername());
            values.put(TOMORROW_MARS_USERFULLNAME, tomorrow_mar_bean_list.get(i).getFullname());
            values.put(TOMORROW_MARS_USEREMAIL, tomorrow_mar_bean_list.get(i).getEmail());
            values.put(TOMORROW_MARS_HOMELY_REMEDY_ID, tomorrow_mar_bean_list.get(i).getHomely_id());
            values.put(TOMORROW_MARS_HOMELY_REMEDY_NAME, tomorrow_mar_bean_list.get(i).getHomely_name());
            values.put(TOMORROW_MARS_PRESCRIPTION_ID, tomorrow_mar_bean_list.get(i).getPrescription_id());
            values.put(TOMORROW_MARS_PATIENT_ID, tomorrow_mar_bean_list.get(i).getPatientid());
            values.put(TOMORROW_MARS_SECONDRY_USERID, tomorrow_mar_bean_list.get(i).getSecondry_userid());
            values.put(TOMORROW_MARS_SECONDRY_USERNAME, tomorrow_mar_bean_list.get(i).getSecondry_username());
            values.put(TOMORROW_MARS_SECONDRY_USERFULLNAME, tomorrow_mar_bean_list.get(i).getSecondry_fullname());
            values.put(TOMORROW_MARS_SECONDRY_USEREMAIL, tomorrow_mar_bean_list.get(i).getSecondry_email());
...
//            if (count <= 0) {
            ...
            long inserted_id = db.insert(TOMORROW_MARS_TABLE, null, values);
//            Log.e("TODAY_MARS_TABLE Values >>>> ", values + "");
            Log.e("TOMORROW_MARS_TABLE", "TOMORROW_MARS_TABLE inserted_id--------->" + inserted_id);
...
//
    ...
    public void update_tomorrow_marsData_admin_for_single_patient(ArrayList<Tomorrow_Mar_Bean> tomorrow_mar_bean_list, String status, String pid) {
        //  SQLiteDatabase db = this.getWritableDatabase();
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (status.equals("online")) {
            ...
            try {
//                for (int i = 0; i < tomorrow_mar_bean_list.size(); i++) {
                delete_tomorrow_mar_record_for_blankid(pid);
//                }
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//                }
    ...
    public ArrayList<Yesterday_Mar_Bean> get_admin_yesterday_mar_fromdb(String prescription_id, String patientId) {
        ArrayList<Yesterday_Mar_Bean> yesterday_Mar_objects_list = new ArrayList<Yesterday_Mar_Bean>();

        String selectQuery = "SELECT * FROM " + YESTERDAY_MARS_TABLE + " WHERE " + YESTERDAY_MARS_PATIENT_ID + " = " + "'" + patientId + "'" + " AND " + YESTERDAY_MARS_PRESCRIPTION_ID + " = " + "'" + prescription_id + "'";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (cursor.moveToFirst()) {
            do {
...
//                if (Date_utility.getCurrentdate().equals(Date_utility.getDate(cursor.getString(2)))) {
                ...
                Yesterday_Mar_Bean hm = new Yesterday_Mar_Bean(cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6),
                        cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13),
                        cursor.getString(14), cursor.getString(15), cursor.getString(16), cursor.getString(17), cursor.getString(18), cursor.getString(19), cursor.getString(20), cursor.getString(21));

                yesterday_Mar_objects_list.add(hm);
//                }

            } while (cursor.moveToNext());
        }

        Log.e("prescription_id", "y1---->" + prescription_id);
        Log.e("patientId", "y2---->" + patientId);
        Log.e("yesterday_Mar_objects_list", "y3---->" + yesterday_Mar_objects_list.size());

        return yesterday_Mar_objects_list;
    }
...
//        ArrayList<Today_Mars_Mar_Bean> Today_Mars_Mar_objects_list = new ArrayList<Today_Mars_Mar_Bean>();
    ...
    public boolean check_admin_yesterday_mar_fromdb(String prescription_id, String patientId, String slot_time) {
//        ArrayList<Today_Mars_Mar_Bean> Today_Mars_Mar_objects_list = new ArrayList<Today_Mars_Mar_Bean>();

        Log.e("check_admin_yesterday_mar_fromdb", "check_admin_yesterday_mar_fromdb  prescription_id--------->" + prescription_id);
        Log.e("check_admin_yesterday_mar_fromdb", "check_admin_yesterday_mar_fromdb  patientId--------->" + patientId);
        Log.e("check_admin_yesterday_mar_fromdb", "check_admin_yesterday_mar_fromdb  slot_time--------->" + slot_time);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (Date_utility.get_yesterday_date().equals(Date_utility.getDate(cursor.getString(9)))) {

                    Log.e("check_admin_yesterday_mar_fromdb", "check_admin_yesterday_mar_fromdb  --------->" + cursor.getString(9));
                    Log.e("check_admin_yesterday_mar_fromdb", "check_admin_yesterday_mar_fromdb  --------->" + cursor.getString(17));
    ...
    public boolean check_admin_tomorrow_mar_fromdb(String prescription_id, String patientId, String slot_time) {
//        ArrayList<Today_Mars_Mar_Bean> Today_Mars_Mar_objects_list = new ArrayList<Today_Mars_Mar_Bean>();

        Log.e("check_admin_tomorrow_mar_fromdb", "check_admin_tomorrow_mar_fromdb  prescription_id--------->" + prescription_id);
        Log.e("check_admin_tomorrow_mar_fromdb", "check_admin_tomorrow_mar_fromdb  patientId--------->" + patientId);
        Log.e("check_admin_tomorrow_mar_fromdb", "check_admin_tomorrow_mar_fromdb  slot_time--------->" + slot_time);


        String selectQuery = "SELECT * FROM " + TOMORROW_MARS_TABLE + " WHERE " + TOMORROW_MARS_PATIENT_ID + " = " + "'" + patientId + "'" + " AND " + TOMORROW_MARS_PRESCRIPTION_ID + " = " + "'" + prescription_id + "'";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (cursor.moveToFirst()) {
            do {

                if (Date_utility.get_tomorrow_date().equals(Date_utility.getDate(cursor.getString(9)))) {

                    Log.e("check_admin_tomorrow_mar_fromdb", "check_admin_tomorrow_mar_fromdb  --------->" + cursor.getString(9));
                    Log.e("check_admin_tomorrow_mar_fromdb", "check_admin_tomorrow_mar_fromdb  --------->" + cursor.getString(17));
