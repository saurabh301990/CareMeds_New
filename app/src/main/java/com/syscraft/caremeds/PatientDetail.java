...
import com.syscraft.caremeds.adapters.Tomorrow_Admin_Adapter_By_Pankaj;
import com.syscraft.caremeds.adapters.Yesterday_Admin_Adapter_By_Pankaj;
...
//    ArrayList<NotesModel_Phase2> bsSiteList;
    ...
    private Yesterday_Admin_Adapter_By_Pankaj yesterday_admin_adapter_by_pankaj;
    private Tomorrow_Admin_Adapter_By_Pankaj tomorrow_admin_adapter_by_pankaj;
...
//                App_Constants.showAlertDialog("Alert", "Please check network connection!", PatientDetail.this, false);
    ...
    private void getAdminData(String callfor) {
...
//        } else {
        ...
        if (!patientIs_absent.equalsIgnoreCase("true")) {
            ...
            admin_prescription_modelArrayList = mydbobj.get_admin_datalist_tab_prescriptions_FromDB(patientId, "this_cycle");
...
//        }
    ...
    private void openMeasureDialog(int position, String measuretype) {
        if ("BMI".equals(measuretype)) {
            ...
            prevouissite = mydbobj.get_last_bs_site_prevouissite(patientId);
                    ...
                    if (NetworkAvailablity.chkStatus(PatientDetail.this) && !is_anything_remains_to_sync) {
                        ...
                        if (require_witness_on_checkin.equalsIgnoreCase("true")) {
                            ...
                            for (int i = 0; i < newchecklist.size(); i++) {
                                ...
                                if (n1.isSelected().equalsIgnoreCase("true")) {
                                    ...
                                    save_offline_checkin("" + n1.getId(), n1.getNew_checked_in_quantity_toupdate(), "0", n1, selected_cycle, false);
                                }
                        ...
                        if (require_witness_on_checkin.equalsIgnoreCase("true")) {
                            ...
                            for (int i = 0; i < newchecklist.size(); i++) {
                                ...
                                if (n1.isSelected().equalsIgnoreCase("true")) {
                                    Log.e("selected id", "---->" + n1.getId());
                                    save_offline_checkin("" + n1.getId(), n1.getNew_checked_in_quantity_toupdate(), "0", n1, selected_cycle, true);
                                }
                ...
                if (tvmeds.isSelected()) {
                    ...
                    if (NetworkAvailablity.chkStatus(PatientDetail.this) && !is_anything_remains_to_sync) {
                        ...
                        for (int i = 0; i < newmedsList.size(); i++) {
                            ...
                            if (i == (newmedsList.size() - 1)) {
                                if (jsonobjlist.size() > 0) {
                                    ...
                                    save_offline_audit(jsonobjlist, selected_cycle, stocklist, false);
                                }
                            }
                        }
                        ...
                        for (int i = 0; i < newmedsList.size(); i++) {
                            ...
                            if (i == (newmedsList.size() - 1)) {
                                if (jsonobjlist.size() > 0) {
                                    save_offline_audit(jsonobjlist, selected_cycle, stocklist, true);
                                }
                            }
                        }
                    }
                            ...
                            for (int i = 0; i < new_admin_modelArrayList.size(); i++) {
                                ...
                                if (nd1.is_edited()) {
                                    ...
                                    if (txttoday.isSelected()) {
                                        new saveAdminData(nd1).execute("0", "Today");
                                        create_today_json(nd1, "0", "");
                                        create_offline_admin(nd1, "Today", false,"0");
                                    } else if (txtyesterday.isSelected()) {
                                        new saveAdminData(nd1).execute("0", "Yesterday");
//                                        create_today_json(nd1);
//                                        create_offline_admin(nd1, "Yesterday",false);
                                    } else if (txtommrow.isSelected()) {
                                        new saveAdminData(nd1).execute("0", "Tomorrow");
//                                        create_today_json(nd1);
//                                        create_offline_admin(nd1, "Tomorrow",false);
                                    }
...
//                                    new saveAdminData(nd1).execute("0");
                                ...
                                if (i == (new_admin_modelArrayList.size() - 1)) {
                                    ...
                                    if (txttoday.isSelected()) {
                                        ...
                                        getAdminData("Yesterday");
                                    } else if (txtommrow.isSelected()) {
                                        getAdminData("Tomorrow");
                                    }
...
//                                    getAdminData();
                        ...
                        for (int i = 0; i < new_admin_modelArrayList.size(); i++) {
                            ...
                            if (nd1.is_edited()) {
                                create_today_json(nd1, "0", "");
                                create_offline_admin(nd1, sel, true,"0");
                            }
                            if (i == (new_admin_modelArrayList.size() - 1)) {
                                if (txttoday.isSelected()) {
                                    getAdminData("Today");
                    ...
                    if (NetworkAvailablity.chkStatus(PatientDetail.this) && !is_anything_remains_to_sync) {
                        ...
                        for (int i = 0; i < new_homely_List.size(); i++) {
                            ...
                            if (h1.is_edited()) {
                                ...
                                create_homely_today_json(h1.getId(), h1.getName(), h1.getDose_to_update(), h1.getPatient_id(), false);
                        ...
                        for (int i = 0; i < new_homely_List.size(); i++) {
                            ...
                            if (h1.is_edited()) {
                                Log.e("is_edited id", "*********---->" + h1.getId());
                                create_homely_today_json(h1.getId(), h1.getName(), h1.getDose_to_update(), h1.getPatient_id(), true);
                        ...
                        for (int i = 0; i < new_return_List.size(); i++) {
                            ...
                            if (nr1.isSelected_inreturn()) {
                                ...
                                if ("Return".equals(nr1.getAction_applied())) {
                                    ...
                                    save_offline_return("" + nr1.getId(), "" + nr1.getQuantity_to_update_on_server(), url_end, qnty_parameter_name, "" + nr1.getAvailable_quantity(), false);
...
//                                    new saveReturnData().execute("" + nr1.getId(), "" + nr1.getQuantity_to_update_on_server(), url_end, qnty_parameter_name);
                                    ...
                                    save_offline_return("" + nr1.getId(), "" + nr1.getQuantity_to_update_on_server(), url_end, qnty_parameter_name, "" + nr1.getAvailable_quantity(), true);
                    ...
                    if (NetworkAvailablity.chkStatus(PatientDetail.this) && !is_anything_remains_to_sync) {
                        ...
                        for (int i = 0; i < measurearraylist.size(); i++) {
                            ...
                            if ("BMI".equals(m1.getName())) {
                                if (m1.isedited().equalsIgnoreCase("true")) {
                                    ...
                                    save_offline_measure(m1.getName(), "" + m1.getValue(), m1.getMeasurement_type_id(), false);
                                }
                                ...
                                if (m1.isedited().equalsIgnoreCase("true")) {
                                    ...
                                    if (!new_bs_site_value.isEmpty()) {
                                        ...
                                        update_sugar_measurement_offline(new_bs_site_value, false);
                                    }
                                }
                        ...
                        for (int i = 0; i < measurearraylist.size(); i++) {
                            ...
                            if ("BMI".equals(m1.getName())) {
                                if (m1.isedited().equalsIgnoreCase("true")) {
//                                    new saveMeasureData().execute(m1.getName(), "" + m1.getValue());
                                    save_offline_measure(m1.getName(), "" + m1.getValue(), m1.getMeasurement_type_id(), true);
                                }
                            } else if ("Pulse".equals(m1.getName())) {
                                if (m1.isedited().equalsIgnoreCase("true")) {
//                                    new saveMeasureData().execute(m1.getName(), "" + m1.getValue());
...
//                                        new Update_sugar_measurement_Async().execute(new_bs_site_value);
                                        ...
                                        update_sugar_measurement_offline(new_bs_site_value, true);
                                    }
                                }
                            } else if ("Lithium".equals(m1.getName())) {
                                if (m1.isedited().equalsIgnoreCase("true")) {
    ...
    private void save_offline_audit(ArrayList<JSONObject> my_jsonobjlist, String selected_cycle, ArrayList<String> stocklist, boolean bool) {
    ...
    private void save_offline_return(String preid, String s1, String url_end, String qnty_parameter_name, String stocktoupdate, boolean bool) {
...
//        Log.e("saveReturnData ", "saveReturnData --------------" + result);
    ...
    private void update_sugar_measurement_offline(String new_bs_site_value, boolean bool) {
        String caretaker_id = PreferenceConnector.readString(getApplicationContext(), PreferenceConnector.USERID, "");
        JSONObject json = new JSONObject();
//        String result = "";
        try {
...
//            mydbobj.update_BSSITE(new_bs_site_value, patientId);
            ...
            mydbobj.update_last_bs_site(new_bs_site_value, patientId);
    ...
    private void save_offline_measure(String name, String val, String measurement_type_id, boolean bool) {
...
//            result = jsonParser.postdata_method(weburl, json.toString());
    ...
    private void create_offline_admin(NEW_ADMIN_MODEL admin_model_to_save_on_server, String selected, boolean bool, String s_userId) {
        ...
        try {
            ...
            json1.put("secondary_user_id", s_userId);
            ...
            } else if (selected.equals("Yesterday")) {
                json1.put("administered_at", "" + date_utility.get_yesterday_administrated_datetime_ukzone());
            } else if (selected.equals("Tomorrow")) {
                json1.put("administered_at", "" + date_utility.get_tomorrow_administrated_datetime_ukzone());
            }

//            json1.put("administered_at", "" + date_utility.get_adminstarated_datetime_ukzone());
            json.put("mar", json1);

            Log.e("saveAdminData offline ", "post data  --->" + json.toString());
//            result = jsonParser.postdata_method(weburl, json.toString());
    ...
    private void save_offline_checkin(String pres_id, int s1, String s2, PRESCRIPTION_Model_Phase2 nd1, String sel_cycle, boolean bool) {
...
//            result = jsonParser.postdata_method(weburl, json.toString());
    ...
    private void create_today_json(NEW_ADMIN_MODEL nd1, String s_userId, String fullname) {
        ...
        try {
            ...
            json1.put("secondary_user_id", s_userId);
            json1.put("seconday_user_fullname", fullname);
            ...
            Log.e("create_today_json ", "post data  --->" + last_admin_json.toString());
    ...
    private void create_homely_today_json(String hid, String hname, String dose_to_update, String patient_id, boolean b) {
...
//         Log.e("BloodSugarValues  ", "  " + sub + "  " + detail);
    ...
    public void AddNoteUpdate(String sub, String content) {
        ...
        if (NetworkAvailablity.chkStatus(PatientDetail.this) && !is_anything_remains_to_sync) {
            ...
            save_offline_general_note(content, sub, false);
        } else {

            save_offline_general_note(content, sub, true);
...
//        Log.e("Notes Values :", notesarraylist + "");
    ...
    private void save_offline_general_note(String content, String sub, boolean bool) {
...
//                }
        ...
        if (call_for.equals("Yesterday")) {

            get_yesterday_admin_list();

        } else if (call_for.equals("Tomorrow")) {

            get_tomorrow_admin_list();

        } else if (call_for.equals("Today")) {


            //----To Get the COLORED DRUG ROUNDS AND THIER PRESCRIPTIONS in ADMIN Today TAB ----//
...
//                    ArrayList<TIME_SLOT_DOSES> Tsd_objects_list = admin_prescription_modelArrayList.get(x).getTIME_SLOT_DOSES_objects_list();
    ...
    private void get_yesterday_admin_list() {
                        ...
                        if (timedosenamelist.get(loop).equals(timeSlotDoses.getShow_as())) {
                            ...
                            if (adminPrescriptionModel.getPrescription_type().equals("Irregular")) {
                                ...
                                if (b == false) {
                                    ...
                                    boolean chk = mydbobj.check_admin_yesterday_mar_fromdb("" + adminPrescriptionModel.getId(), adminPrescriptionModel.getPatient_id(), timeSlotDoses.getSlot_time());
        ...
        Log.e("Before", "New_AdminSectionAdapter---->" + new_admin_modelArrayList.size());
        yesterday_admin_adapter_by_pankaj = new Yesterday_Admin_Adapter_By_Pankaj(this, new_admin_modelArrayList, remedy_and_doselist, patientId);
        mylist.setAdapter(yesterday_admin_adapter_by_pankaj);

        yesterday_admin_adapter_by_pankaj.notifyDataSetChanged();
    ...
    private void get_tomorrow_admin_list() {
                        ...
                        if (timedosenamelist.get(loop).equals(timeSlotDoses.getShow_as())) {
                            ...
                            if (adminPrescriptionModel.getPrescription_type().equals("Irregular")) {
                                ...
                                if (b == false) {
                                    ...
                                    boolean chk = mydbobj.check_admin_tomorrow_mar_fromdb("" + adminPrescriptionModel.getId(), adminPrescriptionModel.getPatient_id(), timeSlotDoses.getSlot_time());
        ...
        Log.e("Before", "New_AdminSectionAdapter---->" + new_admin_modelArrayList.size());
        tomorrow_admin_adapter_by_pankaj = new Tomorrow_Admin_Adapter_By_Pankaj(this, new_admin_modelArrayList, remedy_and_doselist, patientId);
        mylist.setAdapter(tomorrow_admin_adapter_by_pankaj);

        tomorrow_admin_adapter_by_pankaj.notifyDataSetChanged();
...
//            progDialog.show();
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                json1.put("uid", admin_model_to_save_on_server.getUid());
                json1.put("notes_attributes", admin_model_to_save_on_server.getNotesattr());
                Log.e("****** ", "saveAdminData params[1] --->" + params[1]);
                if (params[1].equals("Today")) {
                    json1.put("administered_at", "" + date_utility.get_adminstarated_datetime_ukzone());
                } else if (params[1].equals("Yesterday")) {
                    json1.put("administered_at", "" + date_utility.get_yesterday_administrated_datetime_ukzone());
                } else if (params[1].equals("Tomorrow")) {
                    json1.put("administered_at", "" + date_utility.get_tomorrow_administrated_datetime_ukzone());
                }

                json1.put("due_date", "2016-08-21");

//                json1.put("administered_at", "" + date_utility.get_adminstarated_datetime_ukzone());
                json.put("mar", json1);

                Log.e("saveAdminData ", "saveAdminData  post data  --->" + json.toString());
                result = jsonParser.postdata_method(weburl, json.toString());
                            ...
                            if (from2.equals("checkin")) {
                                ...
                                for (int i = 0; i < newchecklist.size(); i++) {
                                    ...
                                    if (n1.isSelected().equalsIgnoreCase("true")) {
                                        ...
                                        save_offline_checkin("" + n1.getId(), n1.getNew_checked_in_quantity_toupdate(), s_userId, n1, selected_cycle, false);
                                    }
                                }
...
//                                }
                                ...
                                for (int i = 0; i < new_admin_modelArrayList.size(); i++) {
                                    ...
                                    if (nd1.is_edited()) {
                                        ...
                                        if (txttoday.isSelected()) {
                                            new saveAdminData(nd1).execute(s_userId, "Today");
                                            create_today_json(nd1,s_userId,fullname);
                                            create_offline_admin(nd1, "Today", false,s_userId);
                                        } else if (txtyesterday.isSelected()) {
                                            new saveAdminData(nd1).execute(s_userId, "Yesterday");
//                                        create_today_json(nd1);
//                                        create_offline_admin(nd1, "Yesterday",false);
                                        } else if (txtommrow.isSelected()) {
                                            new saveAdminData(nd1).execute(s_userId, "Tomorrow");
//                                        create_today_json(nd1);
//                                        create_offline_admin(nd1, "Tomorrow",false);
                                        }
