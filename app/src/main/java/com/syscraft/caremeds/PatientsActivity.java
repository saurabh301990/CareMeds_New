...
public class PatientsActivity extends BaseActivity {
    ...
    ArrayList<Yesterday_Mar_Bean> yesterday_mars_mar_bean_list;
    ArrayList<Tomorrow_Mar_Bean> tomorrow_mars_mar_bean_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesterday_mars_mar_bean_list = new ArrayList<Yesterday_Mar_Bean>();
        tomorrow_mars_mar_bean_list = new ArrayList<Tomorrow_Mar_Bean>();
        ...
        Log.e("yesterday admin date", "yesterday admin date -------->" + Date_utility.get_yesterday_administrated_datetime_ukzone());
...
//                    new Update_Patients_Related_all_Data(homelyweburl, "6", pid, "homelyweburl").execute();
                    new Update_Patients_Data(pid).execute();
...
//            }
    ...
    private class CompleteResponse extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                        ...
                        for (int p = 0; p < last_cycle_prescriptions_arr.length(); p++) {
                            ...
                            try {
                                ...
                                for (int l = 0; l < tomorrows_mars_arr.length(); l++) {
                                    ...
                                    try {
                                        JSONObject user_obj = new JSONObject(tomorrows_mars_user);
                                        userid = user_obj.optString("id");
                                        username1 = user_obj.optString("username");
                                        fullname1 = user_obj.optString("fullname");
                                        email1 = user_obj.optString("email");
                                    ...
                                    try {
                                        String today_mars_secondary_user = tomorrows_mars_obj.optString("secondary_user");
                                        JSONObject user_obj = new JSONObject(today_mars_secondary_user);
                                        sec_userid = user_obj.optString("id");
                                        sec_username1 = user_obj.optString("username");
                                        Log.e("sec_username1", "sec_username1----->" + sec_username1);
                                    ...
                                    Tomorrow_Mar_Bean tm1 = new Tomorrow_Mar_Bean(tomorrows_mars_id, tomorrows_mars_administered_at, tomorrows_mars_dose,
                                            tomorrows_mars_false_reason,
                                            tomorrows_mars_is_waste, tomorrows_mars_outcome, tomorrows_mars_quantity_wasted, tomorrows_mars_slot_time,
                                            tomorrows_mars_updated_at, userid, username1, fullname1,
                                            email1, "", "", "" + last_cycle_prescriptions_id,
                                            id, sec_userid, sec_username1, sec_fullname1, sec_email1);

                                    tomorrow_mars_mar_bean_list.add(tm1);
                ...
                mydbobj.insert_tomorrow_marsData_admin(tomorrow_mars_mar_bean_list, "online");
    ...
    private class Update_Patients_Data extends AsyncTask<String, Void, String> {

        String patientId;

        public Update_Patients_Data(String pId) {
            patientId = pId;
        }
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            String weburl = baseurl_value + patientId + "/full_show.json/?authentication_token=" + global_auth_token;
            ;
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            Log.e("Response", "API Response for a singe patient ---->" + result);

            thiscycle_chklist.clear();
            nextcycle_chklist.clear();
            lastcycle_chklist.clear();
            notelist.clear();
            measurearraylist.clear();
            returndata_list.clear();
            new_homely_List.clear();
            today_mars_mar_bean_list.clear();
            yesterday_mars_mar_bean_list.clear();
            tomorrow_mars_mar_bean_list.clear();


            try {
                JSONObject jsonObject = new JSONObject(result);
                JSONObject patient_detail_obj = jsonObject.optJSONObject("patient");
                String id = patient_detail_obj.optString("id");
                Log.e("id", "new patient id to update" + id);
...
//                new_patient_Model_List.add(pmh2);
                    ...
                    for (int l = 0; l < homely_remedies_arr.length(); l++) {
                        ...
                        try {
                            ...
                            for (int m = 0; m < homely_remedies_mars_arr.length(); m++) {
                                ...
                                mydbobj.update_homely_today_marsData(homely_Today_Mars_Mar_objects_list, "online", id);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                ...
                String caretaker_id = PreferenceConnector.readString(PatientsActivity.this, PreferenceConnector.LAST_LOGIN_CARETAKER_ID, "");
                mydbobj.update_NotesData_for_single_patient(notelist, "online", "General",id);
                mydbobj.update_last_bs_site_for_single_patient(last_bs_site, id);
                Log.w("LAST_CYCLE", "BEFORE LAST_CYCLE");
                mydbobj.addAllFeed(PatientsActivity.this, lastcycle_chklist);
                Log.w("RETURN", "BEFORE RETURN");
                mydbobj.addAllFeed(PatientsActivity.this, returndata_list);
                ...
                mydbobj.update_today_marsData_admin_for_single_patient(today_mars_mar_bean_list, "online", id);
                mydbobj.update_yesterday_marsData_admin_for_single_patient(yesterday_mars_mar_bean_list, "online", id);
                mydbobj.update_tomorrow_marsData_admin_for_single_patient(tomorrow_mars_mar_bean_list, "online", id);
